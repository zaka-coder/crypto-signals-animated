...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="{{landingTheme('assets/images/fav.png')}}">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="baread-crumb-main-wrapper pt--100">
            <div class="inner">
              <span class="works">Welcome Back</span>
              <h1 class="title rts_hero__title">Log in</h1>
              <span class="bg-text">Log in</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="appoinmnet-area-two rts-section-gap p-5">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <!-- appoinment area two start -->
          <div class="appoinment-area-two plr--120 plr_md--40 plr_sm--30 py-5">
            @yield('content')
          </div>
