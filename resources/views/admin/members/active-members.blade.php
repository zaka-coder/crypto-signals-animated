  ...
  <div class="card">
    <div class="card-body">
      <div class="table-responsive">
        <table id="active-members" class="table table-striped table-bordered"
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <a class="dropdown-item text-danger" href="javascript:;"
                          onclick="deleteMember({{ $member->id }}, 'active-members')"><i
...
@push('scripts')
  <script>
    $(document).ready(function() {
      var table = $('#active-members').DataTable({
        lengthChange: false,
        buttons: ['copy', 'excel'],
        // sort: false,
        columnDefs: [{
      ...
      table.buttons().container()
        .appendTo('#active-members_wrapper .col-md-6:eq(0)');
    ...
    $(document).ready(function() {
      let table = $('#active-members').DataTable();
          ...
          success: function(response) {
            if (response.success) {
              ...
              for (let id of selectedIds) {
                table.row($(`#active-members tbody tr[data-id="${id}"]`)).remove();
              }
