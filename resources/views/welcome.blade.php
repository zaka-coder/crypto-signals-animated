              ...
              <div class="service-area-one-main-wrapper">
                  ...
                  <a href="#">
                    <div class="rts-img-contaciner">
                      <figure class="list-img">
                        <img class="list-img" src="{{landingTheme('assets/images/product/15.jpg')}}"
                          alt="Stream Shop" />
                      </figure>
                    </div>
                ...
                <div class="single-item-service-one">
                  <a href="service-details.html">
                    <div class="rts-img-contaciner">
                      <figure class="list-img">
                        <img class="list-img" src="{{landingTheme('assets/images/product/60.jpg')}}"
                          alt="Stream Shop" />
                      </figure>
                    </div>
                    <div class="list-title col-md-6">
                ...
                <div class="single-item-service-one">
                  <a href="service-details.html">
                    <div class="rts-img-contaciner">
                      <figure class="list-img">
                        <img class="list-img" src="{{landingTheme('assets/images/product/61.jpg')}}"
                          alt="Stream Shop" />
                      </figure>
                    </div>
                    <div class="list-title col-md-6">
                ...
                <div class="single-item-service-one">
                  <a href="service-details.html">
                    <div class="rts-img-contaciner">
                      <figure class="list-img">
                        <img class="list-img" src="{{landingTheme('assets/images/product/62.jpg')}}"
                          alt="Stream Shop" />
                      </figure>
                    </div>
                    <div class="list-title col-md-6">
