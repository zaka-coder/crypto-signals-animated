    ...
    public function index()
    {
      ...
      foreach ($expiringCustomers as $customer) {
        $notification = Notification::create([
          'title' => $customer->discord_name . "'s subscription is expiring on " . $customer->expires_at->format('d-m-Y'),
          'message' => $customer->discord_name . "'s subscription is expiring on " . $customer->expires_at->format('d-m-Y'),
